...
const Temp = (props: Props) => {
    ...
    return (<>
        <div className="cmao-scroll-wrap" ref={$wrap}
            onMouseMove={(e) => { wrapMousemove(e); }}
            onMouseUp={() => { wrapMouseup(); }}
            onWheel={(e) => { wrapOnMousewheel(e); }}>
            <div className="cmao-scroll-box" id={id + '_box'} style={scrollStyle} ref={$scroll} >
                {props.children}
            </div>
            {/* 加载y滚动条 */}
            <div className="cmao-scroll-vertical" style={verticalStyle}>
                <div
            ...
            {/* 加载x滚动条 */}
            <div className="cmao-scroll-horizontal" style={horizontalStyle}>
                <div
